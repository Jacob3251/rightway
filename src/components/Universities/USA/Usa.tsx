...
import image1 from "../../../assets/images/Universities_Images/USA/image-1.png";
import image2 from "../../../assets/images/Universities_Images/USA/image-2.png";
import image3 from "../../../assets/images/Universities_Images/USA/image-3.png";
    ...
    <div className="max-w-[1280px] w-full p-10 pt-16 mx-auto">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center md:items-start">
        ...
        <p className="w-full md:w-[75%] text-[#393939] font-medium text-xl text-center md:text-left mb-5">
          Unlock a wealth of educational possibilities in the land of innovation
          and opportunity, home to leading universities and cutting-edge
          research facilities.
        </p>
      </div>
