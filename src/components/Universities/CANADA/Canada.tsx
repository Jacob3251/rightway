...
import image1 from "../../../assets/images/Universities_Images/CANADA/image-1.png";
import image2 from "../../../assets/images/Universities_Images/CANADA/image-2.png";
import image3 from "../../../assets/images/Universities_Images/CANADA/image-3.png";
    ...
    <div className="max-w-[1280px] w-full p-10 pt-16 mx-auto">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center md:items-start">
        ...
        <p className="w-full md:w-[75%] text-[#393939] font-medium text-xl text-center md:text-left mb-5">
          Experience world-class education in historic institutions renowned for
          their academic excellence and cultural diversity.
        </p>
      </div>
