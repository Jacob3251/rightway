...
import image1 from "../../../assets/images/Universities_Images/AUSTRALIA/image-1.png";
import image2 from "../../../assets/images/Universities_Images/AUSTRALIA/image-2.png";
import image3 from "../../../assets/images/Universities_Images/AUSTRALIA/image-3.png";
    ...
    <div className="max-w-[1280px] w-full p-10 pt-16 mx-auto">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center md:items-start">
        ...
        <p className="w-full md:w-[75%] text-[#393939] font-medium text-xl text-center md:text-left mb-5">
          Immerse yourself in a vibrant tapestry of cultures while exploring the
          dynamic streets of cosmopolitan cities. Unwind with unforgettable
          outdoor adventures.
        </p>
      </div>
